...
const headerClassName = "flex flex-col space-y-1.5 text-center sm:text-left";
const footerClassName = "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2";
const titleClassName = "text-lg font-semibold leading-none tracking-tight";
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn(headerClassName, className)} {...props} />
);
DialogHeader.displayName = "DialogHeader";

const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn(footerClassName, className)} {...props} />
);
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description ref={ref} className={cn(descriptionClassName, className)} {...props} />
));
